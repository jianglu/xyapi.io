export default {
    ...
    invite: {
      ...
      unused: '未使用',
      used: '已使用',
      searchCodes: '搜索邀请码或邮箱...',
      exportCsv: '导出 CSV',
      batchUpdate: '批量修改',
      batchUpdateTitle: '批量修改邀请码',
      selectedCount: '已选择 {count} 个邀请码',
      clearSelection: '清空选择',
      selectCodesFirst: '请先选择邀请码',
      noBatchFieldsSelected: '请至少勾选一个要修改的字段',
      batchUpdateSuccess: '成功修改 {count} 个邀请码',
      failedToBatchUpdate: '批量修改邀请码失败',
      batchFields: {
        status: '状态',
        expiresAt: '过期时间',
        notes: '备注'
      ...
      deleteAllUnused: '删除全部未使用',
      deleteCode: '删除邀请码',
      deleteCodeConfirm: '确定要删除此邀请码吗？此操作无法撤销。',
      deleteAllUnusedConfirm: '确定要删除全部未使用的邀请码吗？此操作无法撤销。',
      deleteAll: '全部删除',
      generateCodesTitle: '生成邀请码',
      generatedSuccessfully: '生成成功',
      codesCreated: '已创建 {count} 个邀请码',
      invitationHint: '邀请码用于限制用户注册，使用后自动标记为已使用。',
      count: '数量',
      generate: '生成',
      copyAll: '全部复制',
      download: '下载',
      codesExported: '邀请码导出成功',
      codeDeleted: '邀请码删除成功',
      codesDeleted: '成功删除 {count} 个未使用的邀请码',
      noUnusedCodes: '没有未使用的邀请码可删除',
      userPrefix: '用户 #{id}',
      failedToLoad: '加载邀请码失败',
      failedToGenerate: '生成邀请码失败',
      failedToExport: '导出邀请码失败',
      failedToDelete: '删除邀请码失败',
      failedToDeleteUnused: '删除未使用的邀请码失败',
      failedToCopy: '复制失败',
      codeExpiry: '邀请码过期',
      neverExpires: '永不过期',
      expiryPresetDays: '{days} 天',
