export default {
    ...
    invite: {
      ...
      description: 'Generate and manage registration invitation codes',
      generateCodes: 'Generate Invitation Codes',
      columns: {
      ...
      unused: 'Unused',
      used: 'Used',
      searchCodes: 'Search invitation code or email...',
      exportCsv: 'Export CSV',
      batchUpdate: 'Batch Update',
      batchUpdateTitle: 'Batch Update Invitation Codes',
      selectedCount: '{count} invitation code(s) selected',
      clearSelection: 'Clear Selection',
      selectCodesFirst: 'Please select invitation codes first',
      noBatchFieldsSelected: 'Please select at least one field to update',
      batchUpdateSuccess: 'Successfully updated {count} invitation code(s)',
      failedToBatchUpdate: 'Failed to batch update invitation codes',
      batchFields: {
        status: 'Status',
        expiresAt: 'Expiry Date',
        notes: 'Notes'
      },
      batchNotesPlaceholder: 'Enter new notes, or leave blank to clear',
      deleteAllUnused: 'Delete All Unused',
      deleteCode: 'Delete Invitation Code',
      deleteCodeConfirm:
        'Are you sure you want to delete this invitation code? This action cannot be undone.',
      deleteAllUnusedConfirm:
        'Are you sure you want to delete all unused invitation codes? This action cannot be undone.',
      deleteAll: 'Delete All',
      generateCodesTitle: 'Generate Invitation Codes',
      generatedSuccessfully: 'Generated Successfully',
      codesCreated: '{count} invitation code(s) created',
      invitationHint:
        'Invitation codes are used to restrict user registration. After use, they are automatically marked as used.',
      count: 'Count',
      generate: 'Generate',
      copyAll: 'Copy All',
      download: 'Download',
      codesExported: 'Invitation codes exported successfully',
      codeDeleted: 'Invitation code deleted successfully',
      codesDeleted: 'Successfully deleted {count} unused invitation code(s)',
      noUnusedCodes: 'No unused invitation codes to delete',
      userPrefix: 'User #{id}',
      failedToLoad: 'Failed to load invitation codes',
      failedToGenerate: 'Failed to generate invitation codes',
      failedToExport: 'Failed to export invitation codes',
      failedToDelete: 'Failed to delete invitation code',
      failedToDeleteUnused: 'Failed to delete unused invitation codes',
      failedToCopy: 'Failed to copy codes',
      codeExpiry: 'Code Expiry',
      neverExpires: 'Never expires',
      expiryPresetDays: '{days} days',
